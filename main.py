...
class MainWidget(QWidget):
    ...
    def InitUi(self):
        ...
        self.dict_clothes = get_dict_clothes(self.connect_to_db, self.parent().user_id)
    ...
    def generate_look_today(self):
        ...
        if not(weather_clothes):
            ...
            return False
        self.outerwear_clothes = weather_clothes.get("Outerwear", False)
        ...
        if self.check_existence_required_types_clothing():
            if self.footwear_clothes and self.jackets_and_coat_clothes:
                self.display_сlothes_in_widget(("outerwear", choice(self.outerwear_clothes)),
